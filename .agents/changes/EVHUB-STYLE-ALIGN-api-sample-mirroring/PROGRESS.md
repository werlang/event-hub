...
|------|-------|--------|-----------------|
| 01 | API Primitives and App Pipeline Alignment | ✅ Completed | Rework delivered: `make checks` passes, route-level ad-hoc error payloads removed in auth/events/auth middleware, and manual readiness/404/500 envelope evidence attached. |
